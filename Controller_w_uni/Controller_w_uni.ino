...
constexpr uint8_t targetAddr[6] = {0x8C, 0xCD, 0xE8, 0xBB, 0x10, 0x76};
constexpr char* targetAddrStr = "8C:CD:E8:BB:10:76";
...
void onConnectedController(ControllerPtr ctl) {
    ...
    for (int i = 0; i < BP32_MAX_GAMEPADS; i++) {
        if (myControllers[i] == nullptr) {
            ...
            ControllerAddr[0] = properties.btaddr[0];
            ControllerAddr[1] = properties.btaddr[1];
            ControllerAddr[2] = properties.btaddr[2];
            ControllerAddr[3] = properties.btaddr[3];
            ControllerAddr[4] = properties.btaddr[4];
            ControllerAddr[5] = properties.btaddr[5];
            Serial.printf("Controller address: %2X:%2X:%2X:%2X:%2X:%2X\n", ControllerAddr[0], ControllerAddr[1], ControllerAddr[2], ControllerAddr[3], ControllerAddr[4], ControllerAddr[5]);
    ...
    for (auto myController : myControllers) {
        if (myController && myController->isConnected() && myController->hasData()) {
            ...
            if (myController->isGamepad()) {
                ...
                // Serial.println("Not gamepad. Disconnect.");
                // myController->disconnect();
            }
        }
    }
